...
[cols="1,3", options="header"]
|===
|Nombre |CU18 - Monitorear inventario
|Actor(es) |Administrador (AC03)
|Objetivo |El administrador obtiene una vista panorámica de cómo está el negocio para tomar decisiones estratégicas
|Precondiciones |PRE-1 Existen hoteles registrados y accesibles dentro del sistema
...
[cols="1,3", options="header"]
|===
|Nombre |CU19 - Generar Reporte de Anulaciones Sospechosas
|Actor(es) |Auditor (AC04)
|Objetivo |El auditor necesita detectar patrones sospechosos en las reservaciones
...
[cols="1,3", options="header"]
|===
|Nombre |CU20 - Revisar ajustes de precios en reservas
|Actor(es) |Auditor (AC04)
|Objetivo |El auditor necesita detectar si alguien modificó el precio de una reserva después de crearla
|Precondiciones |PRE-1. Existen reservas registradas y accesibles dentro del sistema.
...
[cols="1,3", options="header"]
|===
|Nombre |CU21 - Conciliar ingresos por servicios adicionales
|Actor(es) |Auditor (AC04)
|Objetivo |El auditor necesita detectar alguna discrepancia entre los servicios registrados y los servicios reportados
...
[cols="1,3", options="header"]
|===
|Nombre |CU22 - Rastrear reembolsos y descuentos
|Actor(es) |Auditor (AC04)
|Objetivo |El auditor necesita verificar que cada reembolso y descuento tenga una justificación válida
...
[cols="1,3", options="header"]
|===
|Nombre |CU23 - Validar cobros de pagos en línea
|Actor(es) |Auditor (AC04)
|Objetivo |El auditor necesita conciliar que coincidan los registros del sistema, la pasarela de pago y el banco
...
[cols="1,3", options="header"]
|===
|Nombre |CU24 - Consultar bitácora de accesos del personal
|Actor(es) |Auditor (AC04)
|Objetivo |El auditor necesita consultar el historial de accesos del personal al sistema para identificar actividades sospechosas
...
[cols="1,3", options="header"]
|===
|Nombre |CU25 - Consultar informe de inventario
|Actor(es) |Auditor (AC04)
|Objetivo |El auditor necesita obtener un reporte del estado actual de las habitaciones en el sistema para verificarlos contra el estado físico real
...
[cols="1,3", options="header"]
|===
|Nombre |CU26 - Validar uniformidad de políticas y precios por región
|Actor(es) |Auditor (AC04)
|Objetivo |El auditor genera reportes que comparan tarifas, políticas de cancelación y promociones aplicadas en diferentes hoteles, regiones o países para asegurar que sigan las directrices de la marca
